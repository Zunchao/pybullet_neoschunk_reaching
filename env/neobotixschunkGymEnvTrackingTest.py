...
def main():
    ...
    actionIds.append(environment._pb.addUserDebugParameter("arm_4_joint", -dv, dv, dvalue))
    actionIds.append(environment._pb.addUserDebugParameter("arm_5_joint", -dv, dv, dvalue))
    actionIds.append(environment._pb.addUserDebugParameter("arm_6_joint", -dv, dv, dvalue))
    actionIds.append(environment._pb.addUserDebugParameter("arm_7_joint", -dv, dv, dvalue))
    actionIds.append(environment._pb.addUserDebugParameter("basevelocityx", -dv, dv, dvalue))
    actionIds.append(environment._pb.addUserDebugParameter("basevelocityy", -dv, dv, dvalue))
