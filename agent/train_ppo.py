...
def main(_):
  ...
  try:
    ...
    # add on 06122019, copy env.py
  copyfile(os.path.join(parentdir, 'pybullet_neoschunk_reaching/env/neobotixschunk.py'),
             os.path.join(logdir, 'env_robot.py'))
  copyfile(os.path.join(parentdir, 'pybullet_neoschunk_reaching/env/neobotixschunkGymEnv.py'),
             os.path.join(logdir, 'env_gym.py'))
