...
python stable_baselines_scripts/zoo/record_video.py --algo ppo2 --env NeobotixSchunkBulletEnv-v0 -f ~/PycharmProjects/pybullet_neoschunk_reaching/logs/ppo2/NeobotixSchunkBulletEnv-v0_2  -o logs/noprio/videos -n 10000 --seed 1
"""
import gym
import numpy as np
...
if __name__ == '__main__':
    ...
    # Sanity checks
    if args.exp_id > 0:
        log_path = os.path.join(folder, '{}_{}'.format(env_id, args.exp_id))
    else:
