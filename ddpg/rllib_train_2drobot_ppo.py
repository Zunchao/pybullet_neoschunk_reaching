...
python -m ddpg.rllib_train_2drobot_ppo train

python -m ddpg.rllib_train_2drobot rollout .../checkpoint_xx/checkpoint-xx --run PPO --env env_mp500lwa4dpg70 --steps 1000 --out ~/ray_results/rollout.pkl
...
def train_agent(config):
    ...
    if options.command == "train":
        ray.init(object_store_memory=int(1e9))#2G
